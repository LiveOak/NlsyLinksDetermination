...
inputPath <- "F:/Users/wibeasley/Documents/Consulting/BGGrant2011/2013France/Graphs/Timeline.csv"
outputPath <- "F:/Users/wibeasley/Documents/Consulting/BGGrant2011/2013France/Graphs/Timeline.png"
...
ggplot(ds, aes(xmin=StartYear, xmax=StopYear, ymin=HeightMin, ymax=HeightMax, fill=Label)) +
...
#     geom_segment(aes(x=StartYear, xend=StopYear, y=Height, yend=Height, color=Label)) +
