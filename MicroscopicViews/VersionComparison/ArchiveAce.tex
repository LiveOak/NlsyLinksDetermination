...
Older Links: After chaning 'R' to 'RFull'; Excludes Gen1 R=0
...
$R$ Variant & $a_{new}^2$ & $c_{new}^2$ & $e_{new}^2$ & $N_{new}$ & $a_{old}^2$ & $c_{old}^2$ & $e_{old}^2$ & $N_{old}$ \\ 
  \hline
R & .90 & .00 & .10 & 3729 & .90 & .00 & .10 & 3784 \\ 
  RFull & .50 & .19 & .31 & 4227 & .50 & .19 & .31 & 4227 \\ 
  RExplicit & .78 & .06 & .16 & 3702 & .78 & .06 & .16 & 3702 \\ 
...
\end{table}
\newpage 
\section{Subgroups --  RFull }% latex table generated in R 2.15.2 by xtable 1.7-0 package
% Sun Dec 09 16:57:06 2012
\begin{table}[ht]
\begin{center}
\begin{tabular}{rlrrrrrrl}
...
RFull & Included in SEM & $N_{Pairs}$ & $s_1^2$ & $s_2^2$ & $s_{1,2}$ & $r$ & Determinant & PosDefinite \\ 
  \hline
0.000 & TRUE & 443 & 0.93 & 0.82 & 0.23 & 0.26 & 0.7 & TRUE \\ 
  0.125 & TRUE & 88 & 0.91 & 0.95 & 0.15 & 0.16 & 0.8 & TRUE \\ 
  0.250 & TRUE & 238 & 1.01 & 1.14 & 0.26 & 0.24 & 1.1 & TRUE \\ 
  0.375 & TRUE & 45 & 1.00 & 1.18 & 0.48 & 0.44 & 1.0 & TRUE \\ 
  0.500 & TRUE & 3392 & 0.97 & 1.02 & 0.44 & 0.44 & 0.8 & TRUE \\ 
