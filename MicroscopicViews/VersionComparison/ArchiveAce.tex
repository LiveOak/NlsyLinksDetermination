...
{\ttfamily\noindent\bfseries\textcolor{errorcolor}{\#\# Error: The column 'R' should exist in the linksPair file, but does not.}}

{\ttfamily\noindent\bfseries\textcolor{errorcolor}{\#\# Error: The column 'R' should exist in the linksPair file, but does not.}}\end{kframe}
\end{knitrout}
