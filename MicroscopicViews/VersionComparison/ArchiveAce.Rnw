...
<<echo=FALSE>>=
library(stringr)
pathDirectory <- "F:/Projects/Nls/Links2011/MicroscopicViews/VersionComparison/"
# setwd(dir=pathDirectory)
read_chunk(file.path(pathDirectory, "ArchiveAce.R"))
@
...
\textbf{RelationshipPath}: \Sexpr{paste0(relationshipPathPretty, " [ID:", relationshipPath, "]")};
