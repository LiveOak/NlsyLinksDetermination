...
\begin{verbatim}
Newer Links: Uses Gen1 geocode differences
Older Links: Resumed inclusion of Gen2\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{figure}[htbp]
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\includegraphics[width=\maxwidth]{figure/unnamed-chunk-31} \includegraphics[width=\maxwidth]{figure/unnamed-chunk-32} 
\end{knitrout}
