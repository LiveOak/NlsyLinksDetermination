...
\textbf{Newer Links Version}: 54;
\textbf{Older Links Version}: 53;

\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
Newer Links: Adds Gen1 2010 Explicits
Older Links: ??? R Excludes Gen1 R=0, .375, .75
\end{verbatim}
\end{kframe}
\end{knitrout}
