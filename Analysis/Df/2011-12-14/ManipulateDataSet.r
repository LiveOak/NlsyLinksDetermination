rm(list=ls(all=TRUE))
pathLinks <- "F:/Projects/Nls/Links2011/Analysis/Df/2011-12-14/Links2011V28.csv"
pathHeight <- "F:/Projects/Nls/Links2011/Analysis/Df/2011-12-14/Standardized.csv"
pathOutput <- "F:/Projects/Nls/Links2011/Analysis/Df/2011-12-14/DoubleEntered.csv"
...
dsHeight1 <- subset(dsHeight, select=c("CID", "CRace", "CGender", "htst19to25", "age_ht")) #Add things like "CGender" here
dsHeight2 <- subset(dsHeight, select=c("CID", "CRace", "CGender", "htst19to25", "age_ht")) #Add things like "CGender" here
