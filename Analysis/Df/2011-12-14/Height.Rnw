...
#################################################################################################
pathDoubleEntered <- "F:/Projects/Nls/Links2011/Analysis/Df/2011-12-14/DoubleEntered.csv"
...
Subjects were \Sexpr{ageFloorInclusive}+ years old.  Implicit ambiguous sibs were assigned R=\Sexpr{ambiguousImplicitSiblingR}. Z-Scores are restricted to  +/-\Sexpr{zScoreThreshold}.  All height measures are from 19-25 years of age, standardized by gender (Kelly restandardized early December 2011).
