...
read_chunk("./ForDistribution/Outcomes/Gen2Height/Gen2Height.R") #This allows knitr to call chunks tagged in the underlying .R file.
```
...
```{r CalculateDV, fig.height=2, cache=TRUE}
```
...
```{r ComparingWithKelly, fig.width=9, fig.height=6, cache=TRUE} 
```
