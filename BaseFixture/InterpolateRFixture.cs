...
namespace Nls.Tests.BaseFixture {
	...
	public sealed class InterpolateRFixture {
		...
		public void FullSib1vs2 ( ) {
			...
			Pair[] pairs = { new Pair(1, 2, null), new Pair(1, 3, .5f), new Pair(2, 3, .5f) };
			TestInterpolation(pairs, expectedR, 0);
		}
		[TestMethod()]
		public void FullSib1vs3 ( ) {
			const float expectedR = .5f;
			Pair[] pairs = { new Pair(1, 2, .5f), new Pair(1, 3, null), new Pair(2, 3, .5f) };
			TestInterpolation(pairs, expectedR, 1);
		}
		[TestMethod()]
		public void FullSib2vs3 ( ) {
			const float expectedR = .5f;
			Pair[] pairs = { new Pair(1, 2, .5f), new Pair(1, 3, .5f), new Pair(2, 3, null) };
		...
		public void HalfSib1vs2 ( ) {
			...
			Pair[] pairsA = { new Pair(1, 2, null), new Pair(1, 3, .5f), new Pair(2, 3, .25f) };
			Pair[] pairsB = { new Pair(1, 2, null), new Pair(1, 3, .25f), new Pair(2, 3, .5f) };
		...
		public void HalfSib1vs3 ( ) {
			const float expectedR = .25f;
			Pair[] pairsA = { new Pair(1, 2, .5f), new Pair(1, 3, null), new Pair(2, 3, .25f) };
			Pair[] pairsB = { new Pair(1, 2, .25f), new Pair(1, 3, null), new Pair(2, 3, .5f) };
		...
		public void HalfSib2vs3 ( ) {
			const float expectedR = .25f;
			Pair[] pairsA = { new Pair(1, 2, .5f), new Pair(1, 3, .25f), new Pair(2, 3, null) };
			Pair[] pairsB = { new Pair(1, 2, .25f), new Pair(1, 3, .5f), new Pair(2, 3, null) };
			TestInterpolation(pairsA, expectedR, 2);
			TestInterpolation(pairsB, expectedR, 2);
		}
		#endregion
		#region Helpers
		private void TestInterpolation ( Pair[] pairs, float expectedR, Int32 indexOfInterpolatedR ) {
