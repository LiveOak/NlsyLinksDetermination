...
# install.packages("NlsyLinks", repos="http://R-Forge.R-project.org") #Install the NlsyLinks package# install.packages("plyr") #Install the plyr package, if it's not already installed.
...
pathDirectory <- "J:/backup_my_workstation/projects/rodgers_kinship/Sanitized" #Karima, please modify this line for your computer.
